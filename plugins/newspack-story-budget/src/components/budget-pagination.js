...
const Pagination = ( { currentPage, totalPages, onPageChange } ) => {
	return (
		<HStack
			expanded={ false }
			className="newspack-story-budget__pagination"
			justify="end"
			spacing={ 6 }
		>
			<HStack
				...
				expanded={ false }
				spacing={ 1 }
				className="newspack-story-budget__pagination__page-text"
			>
				{
			...
			<HStack
				...
				expanded={ false }
				spacing={ 1 }
				className="newspack-story-budget__pagination__page-buttons"
			>
				<Button
					variant='secondary'
